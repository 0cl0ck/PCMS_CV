...
export const CardItem = ({
  ...
  [key: string]: unknown; // ✅ Remplace `any` par `unknown`
}) => {
  ...
  }, [isMouseEntered, translateX, translateY, translateZ, rotateX, rotateY, rotateZ]); // ✅ Correction

  useEffect(() => {
    handleAnimations();
  }, [handleAnimations]); // ✅ Correction
